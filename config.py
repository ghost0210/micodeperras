...
BOT_TOKEN = '5841971497:AAHZJCzjA8LwN72fkqcewq5YC7dYMRdDoOk' #Aqui va el token del bot
...
static_proxy = 'socks5://KIDEKDYGJEJIGKYHJHGJGKYGKGGKDHRHCJLIFDLK' #agrega si kieres tener un proxy statico Con @raydel0307 si kieres comprar un proxy
